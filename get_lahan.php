...
if ($userId > 0) {
    // Ambil data dari tabel 'lahan' berdasarkan userId
    $sql = "SELECT * FROM lahan WHERE user_id = ?";
    ...
    if ($result->num_rows > 0) {
        ...
        echo json_encode(array("status" => "error", "message" => "Tidak ada data lahan yang ditemukan untuk user_id: $userId"));
    }
